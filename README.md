...
- The mobile app is additional, scope-limited app, which implements only the most important group member functionality: login / register, view matches, join / unjoin match, comment on matc